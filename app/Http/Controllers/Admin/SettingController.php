...
class SettingController extends Controller
{
    ...
    public function index(){
        ...
        try {
            ...
            $color = Setting::where('var','color')->first()->value;
            return view('admin.setting.index',compact('facebook','insta','twitter','snapchat','meta_title','meta_desc','color'));
        }catch (Throwable $e){
    ...
    public function store(Request $request){
        try {
            ...
            Setting::where('var','color')->first()->update([
                'value'=>$request->color
            ]);
