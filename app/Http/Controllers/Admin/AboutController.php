...
class AboutController extends Controller
{
    public function index(){
        try {
            ...
            $about_heb = Setting::where('var','about_heb')->first()->value;
            return view('admin.about.index',compact('about_ar','about_en','about_heb'));
        }catch (Throwable $e){
    ...
    public function store(Request $request){
        try {
            ...
            Setting::where('var','about_heb')->first()->update([
                'value'=>$request->about_heb
            ]);
